    ...
    if (this.state.email.length === 0 || this.state.password.length === 0) {
      ...
      try {
        await api.post('/users', {
          ...
          password_confirmation: this.state.confirmpasswd,
    ...
    return (
      <Container>
        ...
        <Picker
          ...
          autoCapitalize="none"
        >
          <Picker.Item label="Selecio um tipo" value="" />
          <Picker.Item label="Pesso Física" value="F" />
          <Picker.Item label="Pessoa Jurídica" value="P" />
        </Picker>
        <Input
          placeholder="Senha"
